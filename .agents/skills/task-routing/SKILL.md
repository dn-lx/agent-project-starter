...
4. Load only skills explicitly required by the workflow or by detected risk.
5. Keep platform/MCP/setup documents unloaded unless the task actually depends on them.
6. If no superpower fits, use the smallest directly relevant skill instead.
